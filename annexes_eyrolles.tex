...
\lstinputlisting[caption={\atemplatemaj\ de listing du module de référentiel des langues d'\aey}, label={listing:eyrolles_ref-langues_template-list}]{code/eyrolles_ref-langues_template-list.php}

\lstinputlisting[caption={\apartialmaj\ des lignes du tableau de listing du module de référentiel des langues d'\aey}, label={listing:eyrolles_ref-langues_template-row}]{code/eyrolles_ref-langues_template-row.php}

\lstinputlisting[caption={\atemplatemaj\ de création du module de référentiel des langues d'\aey}, label={listing:eyrolles_ref-langues_template-new}]{code/eyrolles_ref-langues_template-new.php}

\lstinputlisting[caption={\apartialmaj\ du formulaire du module de référentiel des langues d'\aey}, label={listing:eyrolles_ref-langues_template-form}]{code/eyrolles_ref-langues_template-form.php}
